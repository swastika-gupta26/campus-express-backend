                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                        <button
                            ...
                            className="hidden md:inline-flex items-center gap-1.5 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white px-3.5 sm:px-4 py-2 rounded-xl text-sm font-semibold transition-colors shadow-sm shadow-orange-500/30"
                        >
                ...
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div
                            ...
                            <p className="text-xs font-medium text-slate-500 mt-1.5">Products in Stock</p>
                        </div>
                    </div>
                </div>
